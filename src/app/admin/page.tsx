                ...
                <ul className="p-8">
                  <li className="mb-6 pb-6 flex items-center justify-left">
                    ...
                    <button
                      ...
                      className="text-nowrap flex text-base lg:mr-0 lg:inline-flex lg:px-0 text-dark hover:text-primary dark:text-white/70 dark:hover:text-white"
                    >
                      &nbsp;&nbsp;User Mangement
                    </button>
                  </li>
