...
const Footer = () => {
  ...
  return (
    <>
      <footer className="relative z-10 bg-white dark:bg-gray-dark bg-[url('/images/choose/01.jpg')] bg-cover bg-center bg-no-repeat">
        <div className="bg-sky-900/80 dark:bg-gray-dark pt-16 md:pt-20 lg:pt-24">
          <div className="container">
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
                <div className="mb-12 max-w-[450px] lg:mb-16">
                  ...
                  <ul className="mb-9 text-base leading-relaxed text-white dark:text-body-color-dark">
                    <li>
                      <Link
                        ...
                        className="flex flex-row items-center mb-4 inline-block text-white dark:text-body-color-dark duration-300 hover:text-amber-500"
                      >
                    ...
                    <li>
                      <Link
                        ...
                        className="flex flex-row items-center mb-4 inline-block text-white dark:text-body-color-dark duration-300 hover:text-amber-500"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#ffffff"><path d="M480-400q-33 0-56.5-23.5T400-480q0-33 23.5-56.5T480-560q33 0 56.5 23.5T560-480q0 33-23.5 56.5T480-400Zm-40-240v-200h80v200h-80Zm0 520v-200h80v200h-80Zm200-320v-80h200v80H640Zm-520 0v-80h200v80H120Z" /></svg>
                  ...
                  <div className="flex items-center">
                    <a
                      ...
                      className="mr-6 text-white dark:text-body-color-dark duration-300 hover:text-amber-500"
                    >
                      <svg
                        width="18"
                        height="18"
              ...
              <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                <div className="mb-12 lg:mb-16">
                  <h2 className="mb-10 text-xl font-bold text-white dark:text-body-color-dark">
                    Useful Links
                  </h2>
                  <ul>
                    <li>
                      <Link
                        href="/"
                        className="mb-4 inline-block text-base text-white dark:text-body-color-dark duration-300 hover:text-amber-500"
                      >
                        Feature
                      </Link>
                    </li>
            ...
            <div className="py-8">
              <p className="text-center text-base text-white dark:text-body-color-dark">
                Copyright {" "}
                <a
                  href="/"
                  target="_blank"
