...
const SingleProduct = ({ product }: { product: Product }) => {
  ...
  return (
    <>
      <div className="relative w-[300px] h-[450px] transition duration-200 hover:-translate-y-2">
        <div className="wow fadeInUp justify-center items-center text-center saturate-50 hover:filter-none shadow-2xl" data-wow-delay=".15s">
          <div className="mx-auto flex flex-wrap items-center justify-center">
            <Image src={image} alt="offer image" width={300} height={450} />
            {/* <Image src="/images/services/trans.png" alt="offer image" className="absolute" width={300} height={450} /> */}
          </div>
          <div className="absolute inset-0 text-center">
            <div className="w-[300px] p-3 bg-black/80 text-white flex items-center justify-center">
              {title}
            </div>
          </div>
          <div className="absolute bottom-0">
            <div className="px-5 w-[300px] h-[60px] bg-black/80 text-white flex items-center justify-between">
          ...
          <div className="absolute inset-0 w-[300px] h-[450px] flex items-center justify-center">
