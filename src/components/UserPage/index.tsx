      ...
      <section className="overflow-hidden">
        <div className="">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 pt-[50px] lg:w-3/12 bg-gray-dark">
              <div className="mb-10">
              ...
              {/* <div className="shadow-three dark:bg-gray-dark mb-10 rounded-md bg-white dark:shadow-none">
                <h3 className="border-b border-body-color border-opacity-10 px-8 py-4 text-lg font-semibold text-dark dark:text-body-color-dark dark:border-opacity-10">
                  Popular Category
                </h3>
            ...
            <div className="w-full px-10 pt-[50px] lg:w-9/12 min-h-[800px]">
