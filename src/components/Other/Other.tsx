...
const Other = (props: Props) => {
  ...
  const onSend = async () => {
    ...
    try {
      ...
      const response = await CartService.register(userid, '', 'Hire Us', '', '', name, email, phone, message);
  ...
  return (
    <>
      ...
      <div className="w-full min-h-[500px]">
        ...
        /> */}
        <AntdCarousel autoplay className="w-full min-h-[500px]">
          <div>
            <div className="w-full min-h-[500px] flex items-center justify-center bg-[url('/images/other/1.png')] bg-cover bg-left-top bg-no-repeat">
              <div className="container">
                <div className="-mx-4 flex flex-wrap items-center">
                  <div className="w-full px-4 py-4 md:w-8/12 lg:w-7/12 bg-white flex items-center justify-center">
                    <div className="max-w-[800px]">
                      <h1 className="text-2xl font-bold backdrop-blur-sm text-black dark:text-white sm:text-3xl">
                        Hire Us
                      </h1>
                    </div>
                  </div>
                  <div className="w-full px-4 py-4 md:w-8/12 lg:w-7/12 bg-white/50 flex items-center justify-center">
                    <div className="max-w-[800px]">
                      <h1 className="text-2xl font-bold backdrop-blur-sm text-white dark:text-white sm:text-3xl">
                        For Blueprints
                      </h1>
                    </div>
                  </div>
          ...
          <div>
            <div className="w-full min-h-[500px] flex items-center justify-center bg-[url('/images/other/2.png')] bg-cover bg-left-top bg-no-repeat">
              <div className="container">
                <div className="-mx-4 flex flex-wrap items-center">
                  <div className="w-full px-4 py-4 md:w-8/12 lg:w-7/12 bg-white flex items-center justify-center">
                    <div className="max-w-[800px]">
          ...
          <div>
          <div className="w-full min-h-[500px] flex items-center justify-center bg-[url('/images/other/3.png')] bg-cover bg-left-top bg-no-repeat">
              <div className="container">
                <div className="-mx-4 flex flex-wrap items-center">
                  <div className="w-full px-4 py-4 md:w-8/12 lg:w-7/12 bg-white flex items-center justify-center">
                    <div className="max-w-[800px]">
